...
class Student(models.Model):
    ...
    description = models.TextField(max_length=100000,null=True,verbose_name=u"Motivation  ", help_text="What are your motives for applying to this e-workshop?",  blank=True)
